...
class BankWork
{
    ...
    { 
        ...
        try
        {
            ...
            System.out.print("Enter the account number to edit : ");
            System.out.flush();
            ...
            if (valid==true)
            {
                ...
                accType[account]=str;
                    ...
                    // Updating the amount after Editing.
                    System.out.println("\nAfter Updation...");
                    System.out.println("Account Number :  "+account);
		    System.out.println("Account Type :  "+accType[account]);
                    System.out.println("Balance Amount :  "+balamount[account]+"\n\n\n");
    ...
    { 
        ...
        try
        {
		    ...
		    System.gc();
                    System.out.println("\nAfter Deletion...");
                    System.out.println("Account Number :  "+account+" has been deleted");

            }
        }
        catch(Exception e)
        {
        	System.out.println("Exception in deleting record.....");
        }
    }	
};
